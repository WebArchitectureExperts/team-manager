...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { number: @phone.number, person: @phone.person, type: @phone.type } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { number: @phone.number, person: @phone.person, type: @phone.type } }
